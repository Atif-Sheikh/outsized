  ...
  renderTexts = (title, link, duration, duration2, place) => {
    ...
    return (
      <div style={{ marginBottom: 20 }}>
        ...
        <Typography className={classes.housingcom}>{link}</Typography>
        <Typography className={classes.timeDuration}>
          {duration}
          {duration2.length ? <span className={classes.oval} /> : null}
          {duration2}
        </Typography>
    ...
    return (
      <div className={classes.mainContainer}>
        ...
        <Typography className={classes.dummyText}>
          ...
          consectetur condimentum nunc, vel ultrices ante elementum in. Aliquam
          bibendum egestas nunc. Morbi a urna arcu. Nunc euismod purus ut elit
          luctus aliquet. Maecenas a interdum tortor. Sed tempus quam eget
          egestas pellentesque. Praesent vehicula varius lectus, vel maximus
          turpis rhoncus a.
        </Typography>
                ...
                <div>
                  <div>
                    ...
                    <Typography className={classes.typos}>
                      ...
                      Nam consectetur condimentum nunc, vel ultrices ante
                      elementum in. Aliquam bibendum egestas nunc. Morbi a urna
                      arcu.
                    </Typography>
                  </div>
                </div>
