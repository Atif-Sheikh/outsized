...
import { styles } from "@styles/firmComponents/VerifyEmail.styles.js";
...
class VerifyEmailAddress extends Component {
  ...
  componentWillReceiveProps(NewProps) {
    if (NewProps.email.valid) {
      Router.push("/firm/basic-profile");
  ...
  render() {
    ...
    return (
      <div className={classes.paper}>
        ...
        <div>
          <Link href="/firm/basic-profile">
            <IconButton onClick={() => Router.push("/firm/basic-profile")}>
