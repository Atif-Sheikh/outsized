...
import { styles } from "@styles/FirmComponents/SetPassword.styles.js";
import InputArea from "../../ReuseableComponents/InputArea";
import { connect } from "react-redux";
import { firmSignUpApi } from "@actions/firm";
...
const mapStateToProps = state => {
  return {
    ...
    userData: state.firmSignUpReducer.userData,
...
const mapDispatchToProps = dispatch => {
  return {
    firmSignUpApi: (data, snackShow, snackHide, goto) =>
      dispatch(firmSignUpApi(data, snackShow, snackHide, goto))
  };
};
